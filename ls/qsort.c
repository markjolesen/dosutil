 ...
 *
 *  http://mirrors.ibiblio.org/CTAN/indexing/makeindexk/
 *
 */
...
typedef int (*qq_compar_fn_t)(const void __far *, const void __far *);
extern void qqsort (void __far *base, size_t n, size_t size, qq_compar_fn_t compar);
...
static void qst(char __far *base, char __far *max);
/*
...
void
/*qqsort*/qsort(void __far *base, size_t n, size_t size, qq_compar_fn_t compar)
{
    /*register*/ char __far *i;
    /*register*/ char __far *j;
    /*register*/ char __far *lo;
    /*register*/ char __far *hi;
    /*register*/ char __far *min;
    /*register*/ char c;
    char __far *max;
    ...
    thresh = qsz * THRESH;
    mthresh = qsz * MTHRESH;
    max = (char __far *)base + n * qsz;
    if (n >= THRESH) {
	qst(base, max);
	hi = (char __far *)base + thresh;
    } else {
	hi = max;
    }
    /*
...
static void
qst(char __far *base, char __far *max)
{
    /*register*/ char __far *i;
    /*register*/ char __far *j;
    /*register*/ char __far *jj;
    /*register*/ char __far *mid;
    /*register*/ int ii;
    /*register*/ char c;
    void __far *tmp;
    size_t lo;
